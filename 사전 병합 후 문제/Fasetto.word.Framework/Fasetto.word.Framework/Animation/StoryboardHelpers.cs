...
namespace Fasetto.word.Framework
{
    ...
    public static class StoryboardHelpers
    {
        ...
        public static void AddSlideFromRight(this Storyboard storyboard, float seconds, double offset, float declerationRatio = 0.9f)
        {
        ...
        /// <param name="offset"></param>
        /// <param name="declerationRatio"></param>
        public static void AddSlideToLeft(this Storyboard storyboard, float seconds, double offset, float declerationRatio = 0.9f)
        {
            // Create the margin animate from right
            var animation = new ThicknessAnimation
            {
